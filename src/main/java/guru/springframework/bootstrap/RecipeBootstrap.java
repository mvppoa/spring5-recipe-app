...
public class RecipeBootstrap {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.getIngredients().add(new Ingredient("Kosher salt",new BigDecimal(.5),teaSpoonUnitOfMeasure));
        guacRecipe.getIngredients().add(new Ingredient("Fresh lime juice or lemon juice",new BigDecimal(2),tableSpoonUnitOfMeasure));
        guacRecipe.getIngredients().add(new Ingredient("Minced red onion or thinly sliced green onion",new BigDecimal(2),tableSpoonUnitOfMeasure));
        guacRecipe.getIngredients().add(new Ingredient("Cilantro",new BigDecimal(2),tableSpoonUnitOfMeasure));
        guacRecipe.getIngredients().add(new Ingredient("Freshly grated black pepper",new BigDecimal(2),dashUnitOfMeasure));
        guacRecipe.getIngredients().add(new Ingredient("Ripe tomato, seeds and pulp removed, chopped",new BigDecimal(2),eachUnitOfMeasure));
